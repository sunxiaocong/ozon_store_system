      ...
      <a-row :gutter="[20,20]">
        <a-col :sm="24" :md="12" :lg="6">
          <a-card size="small" title="商品总数">
            ...
            <div class="box">
              <div class="box-top">
                <span class="box-value">{{ data.thing_all }}<span class="v-e">种</span></span>
                <a-icon type="profile" theme="twoTone" style="font-size: 24px;"/>
              </div>
              <div class="box-mid">
                <span>在售商品 {{ data.thing_selling }} 种</span>
              </div>
              <div class="box-bottom">
                <span>缺货商品 {{ data.thing_clean }} 种</span>
              </div>
            </div>
          </a-card>
        </a-col>
        ...
        <a-col :sm="24" :md="12" :lg="6">
          <a-card size="small" title="总资产">
            ...
            <div class="box">
              <div class="box-top">
                <span class="box-value">{{ data.total_assets }}<span class="v-e">RMB</span></span>
                <a-icon type="profile" theme="twoTone" style="font-size: 24px;"/>
              </div>
              <div class="box-mid">
                <span>fbs库存估值 {{ data.thing_assets }} RMB</span>
              </div>
              <div class="box-mid2">
                <span>fbo库存估值 {{ data.thing_fbo_assets }} RMB</span>
              </div>
              <div class="box-bottom">
                <span>现金余额 {{ data.finance_assets }} RMB</span>
              </div>
            </div>
          </a-card>
        </a-col>
        ...
        <a-col :sm="24" :md="12" :lg="6">
          <a-card size="small" title="运输中订单">
            <a-tag color="green" slot="extra">运输中</a-tag>
            <div class="box">
              <div class="box-top">
                <span class="box-value">{{ data.order_delivering_count }}<span class="v-e">单</span></span>
                <a-icon type="carry-out" theme="twoTone" style="font-size: 24px;"/>
              </div>
              <div class="box-bottom">
                <span>共 {{ data.order_delivering_price }} (卢布)</span>
              </div>
            </div>
          </a-card>
        </a-col>
        ...
        <a-col :sm="24" :md="12" :lg="6">
          <a-card size="small" title="已签收订单">
            <a-tag color="blue" slot="extra">已签收</a-tag>
            <div class="box">
              <div class="box-top">
                <span class="box-value">{{ data.order_delived_count }}<span class="v-e">单</span></span>
                <a-icon type="interaction" theme="twoTone" style="font-size: 24px;"/>
              </div>
              <div class="box-bottom">
                <span>共 {{ data.order_delived_price }} (卢布)</span>
              </div>
            </div>
          </a-card>
        </a-col>
        ...
        <a-col :sm="24" :md="12" :lg="6">
          <a-card size="small" title="取消订单">
            ...
            <div class="box">
              ...
              <div class="box-bottom">
                <span>共 {{ data.order_cancel_price }} (卢布)</span>
              </div>
            </div>
          </a-card>
        </a-col>
