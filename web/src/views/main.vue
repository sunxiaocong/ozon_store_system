      ...
      <a-layout-sider v-model="collapsed" collapsible>
        <a-menu style="overflow:auto; overflow-x: hidden;" v-model:selectedKeys="selectedKeys" theme="dark"
          ...
          <a-sub-menu>
            ...
            <a-menu-item key="profit_statement">
              <database-outlined/>
              <span>店铺利润</span>
            </a-menu-item>
            <a-menu-item key="store_ad">
              <database-outlined/>
              <span>店铺广告</span>
            </a-menu-item>
            <a-menu-item key="ad_cost">
              <database-outlined/>
              <span>广告花费</span>
            </a-menu-item>
            <a-menu-item key="order_auto_msg">
              <database-outlined/>
              <span>订单提示推送</span>
            </a-menu-item>
            <a-menu-item key="unsalable_rank">
              <database-outlined/>
              <span>滞销商品排行榜</span>
            </a-menu-item>
          </a-sub-menu>
