...
from myapp.models import Thing, Finance, Order, Classification, Tag, User, Comment, Record, LoginLog, OpLog, Banner, \
    Ad, Notice, ErrorLog, Address, OzonCost, RefundRank, ProfitStatement


class RefundRankSerializer(serializers.ModelSerializer):
    class Meta:
        model = RefundRank
        fields = ['sku', 'count', 'amount']


class OzonCostSerializer(serializers.ModelSerializer):
...
class ProfitStatementSerializer(serializers.ModelSerializer):
    class Meta:
        model = ProfitStatement
        fields = '__all__'
